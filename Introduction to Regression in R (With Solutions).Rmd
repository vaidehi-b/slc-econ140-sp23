...
model_multiple <- lm(log_sales_hotel ~ log_ind_lang + inc_m + educ_years, data = mexico)
...
model_iv_2 <- ivreg(log_sales_hotel ~ log_ind_lang + logtemp + logprecip | logtemp + logprecip + inc_m, data = mexico)
